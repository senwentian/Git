...
void Gyro_Info(void)
{
    ...
    Gyro_Infomation.Angular_velocity_z = (double)(Gyro_Message) / Gyro_scale_factor / 10000.0;
    Gyro_Infomation.Gyro_Temperature = ((Gyro_Msg[6]  |  Gyro_Msg[7] << 7) & 0x3FFF) % 16;
